...
Var
  ...
  GetSteamClient: Function():Pointer; CDecl;
  ...
  GetSteamUser: Function():Pointer; CDecl;
  GetSteamFriends: Function():Pointer; CDecl;
  GetSteamUtils: Function():Pointer; CDecl;
  GetSteamMatchmaking: Function():Pointer; CDecl;
  GetSteamUserStats: Function():Pointer; CDecl;
  GetSteamApps: Function():Pointer; CDecl;
  GetSteamNetworking: Function():Pointer; CDecl;
  GetSteamMatchmakingServers: Function():Pointer; CDecl;
  GetSteamRemoteStorage: Function():Pointer; CDecl;
  GetSteamScreenshots: Function():Pointer; CDecl;
  GetSteamHTTP: Function():Pointer; CDecl;
  GetSteamUnifiedMessages: Function():Pointer; CDecl;
  GetSteamController: Function():Pointer; CDecl;
  GetSteamUGC: Function():Pointer; CDecl;
  GetSteamAppList: Function():Pointer; CDecl;
  GetSteamMusic: Function():Pointer; CDecl;
  GetSteamMusicRemote: Function():Pointer; CDecl;
...
Var
  ...
  GetSteamClientGameServer: Function():Pointer; CDecl;
  GetSteamGameServer: Function():Pointer; CDecl;
  GetSteamGameServerUtils: Function():Pointer; CDecl;
  GetSteamGameServerNetworking: Function():Pointer; CDecl;
  GetSteamGameServerStats: Function():Pointer; CDecl;
  GetSteamGameServerHTTP: Function():Pointer; CDecl;
...
Begin
  ...
  GetSteamClient := GetProcAddress(SteamHandle, 'SteamClient_');
  ...
  GetSteamUser := GetProcAddress(SteamHandle, 'SteamUser');
  GetSteamFriends := GetProcAddress(SteamHandle, 'SteamFriends');
  GetSteamUtils := GetProcAddress(SteamHandle, 'SteamUtils');
  GetSteamMatchmaking := GetProcAddress(SteamHandle, 'SteamMatchmaking');
  GetSteamUserStats := GetProcAddress(SteamHandle, 'SteamUserStats');
  GetSteamApps := GetProcAddress(SteamHandle, 'SteamApps');
  GetSteamNetworking := GetProcAddress(SteamHandle, 'SteamNetworking');
  GetSteamMatchmakingServers := GetProcAddress(SteamHandle, 'SteamMatchmakingServers');
  GetSteamRemoteStorage := GetProcAddress(SteamHandle, 'SteamRemoteStorage');
  GetSteamScreenshots := GetProcAddress(SteamHandle, 'SteamScreenshots');
  GetSteamHTTP := GetProcAddress(SteamHandle, 'SteamHTTP');
  GetSteamUnifiedMessages := GetProcAddress(SteamHandle, 'SteamUnifiedMessages');
  GetSteamController := GetProcAddress(SteamHandle, 'SteamController');
  GetSteamUGC := GetProcAddress(SteamHandle, 'SteamUGC');
  GetSteamAppList := GetProcAddress(SteamHandle, 'SteamAppList');
  GetSteamMusic := GetProcAddress(SteamHandle, 'SteamMusic');
  GetSteamMusicRemote := GetProcAddress(SteamHandle, 'SteamMusicRemote');
  ...
  GetSteamClientGameServer := GetProcAddress(SteamHandle, 'SteamClientGameServer');
  GetSteamGameServer := GetProcAddress(SteamHandle, 'SteamGameServer');
  GetSteamGameServerUtils := GetProcAddress(SteamHandle, 'SteamGameServerUtils');
  GetSteamGameServerNetworking := GetProcAddress(SteamHandle, 'SteamGameServerNetworking');
  GetSteamGameServerStats := GetProcAddress(SteamHandle, 'SteamGameServerStats');
  GetSteamGameServerHTTP := GetProcAddress(SteamHandle, 'SteamGameServerHTTP');
